class zcl_upload_data_script_5717 definition
  public
  final
  create public .
...
class zcl_upload_data_script_5717 implementation.
...
*last_changed_at       : abp_lastchange_tstmpl;
 ...
 data: lt_acc_categ type table of zacc_categ_5717,
          lt_catego    type table of zcatego_5717,
          lt_clientes  type table of zclientes_5717,
          lt_clnts_lib type table of zclnts_lib_5717,
          lt_libros    type table of zlibros_5717.
...
******** TABLA1 ********
    ...
    delete from zacc_categ_5717.
    insert zacc_categ_5717 from table @lt_acc_categ.
...
******** TABLA2 ********
    ...
    "Delete possible entries; insert new entries
    delete from zcatego_5717.
    insert zcatego_5717 from table @lt_catego.
...
******** TABLA3 ********
    ...
    "Delete possible entries; insert new entries
    delete from zclientes_5717.
    insert zclientes_5717 from table @lt_clientes.
...
******** TABLA4
    ...
    "Delete possible entries; insert new entries
    delete from zclnts_lib_5717.
    insert zclnts_lib_5717 from table @lt_clnts_lib.
...
******** TABLA5 ********
    ...
    'https://eltinteroeditorial.com/wp-content/uploads/2017/06/c%C3%B3mo-es-el-proceso-de-edici%C3%B3n.jpg' ) ).
    "Delete possible entries; insert new entries
    delete from zlibros_5717.
    insert zlibros_5717 from table @lt_libros.
